...
<head>
	<title>Neonled.Id - Checkout</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?= $_SESSION['name'] ?> telah membeli <?php echo $itungtrans3 ?> barang di Neonled.Id</span></h1>
		...
		<input type="hidden" name="total_berat" value="<?= isset($totalberat) ? $totalberat : 1; ?>">
		...
		<script>
			$(document).ready(function() {
				...
				$("select[name=nama_paket]").on("change", function() {
					...
					$('input[name=total_harga]').val('Rp' + Intl.NumberFormat('id-ID').format(total));
				})
			});
		</script>
		</div>
		<div class="checkout-left">
			<div class="checkout-left-basket">
				...
				<ul>
					...
					<h1><input type="text" name="total_harga" value="Rp<?php echo number_format($total) ?>" disabled></h1>
				</ul>
			</div>
			<br>
		...
		<center>
			...
			<h2>Barang akan kami kirimkan ke alamat yang tertera sesuai dengan yang ada pada akun anda.</h2>
			<br>
